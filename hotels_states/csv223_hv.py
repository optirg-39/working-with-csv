...
print("Please check the spellings before input i.e Maharashtra, Tamilnadu, Karnataka, Cost, Rating, cheapest, "
      "average, highest , India,")
...
def hotels_performance(state,cost_rating,operation):
    with open('hotels.csv', 'r') as f:
        ...
        """Highest price Hotels in India & states"""
        ...
        """Highest rated hotels in Indai & States"""
        ...
        """Average rating of Hotels in Indai & states"""
        ...
        """Average price of hotels in India & states"""
        ...
        """Cheapest hotel price in India & States"""
        if cost_rating == 'cost' and operation == 'cheapest':
            ...
            for row in csv_data:
                if row['State'] == state or state=="India":
                    if min == int(row['Cost']):
                        l.append(row['Hotel Code'])
            print(f'Hotel with cheapest price in {state} are {l} with price {min}')

        """Cheapest ratings of Hotels in India & staes"""
